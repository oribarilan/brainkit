...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Adding contacts          | Agent uses built-in file editing, guided by the contacts skill for format                                                                                              | Agent uses built-in file editing, guided by contacts skill in `~/.config/brainkit/copilot/skills/brainkit/references/contacts.md`     |
...
| Cross-referencing        | Agent checks contacts when people are mentioned, guided by skill instructions in the system prompt                                                                     | Agent checks contacts when people are mentioned, guided by skill instructions in `~/.config/brainkit/copilot/copilot-instructions.md` |
